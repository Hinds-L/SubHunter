package com.bluecirclesquare.www.subhunter;
...
public class SubHunter extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    blankBitmap = Bitmap.createBitmap(numberHorizontalPixels,
        numberVerticalPixels, Config.ARGB_8888);
  ...
  void draw() {
    ...
    for (int i = 0; i < gridWidth; i++) {
      canvas.drawLine(blockSize * i, 0, blockSize * i, numberVerticalPixels,
          paint);
    }
    ...
    canvas.drawText("Shots Taken and Distance: " + shotsTaken,
        +distanceFromSub,
  ...
  from the sub and determine a hit or miss
   */
